...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [icExcel];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_launcher_icon_2.png
  AssetGenImage get launcherIcon2 =>
      const AssetGenImage('assets/images/img_launcher_icon_2.png');

  /// List of all assets
  List<AssetGenImage> get values => [launcherIcon, launcherIcon2];
}
